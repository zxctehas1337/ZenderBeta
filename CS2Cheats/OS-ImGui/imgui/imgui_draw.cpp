...
void ImGui::DragonBurnDefaultStyle(ImGuiStyle* dst)
{
    ...
    style.WindowRounding = 0.0f;        // Flat
    ...
    style.GrabRounding = 0.0f;          // Flat
    style.TabRounding = 0.0f;           // Flat
    ...
    ImVec4 bg0 = ImVec4(0.08f, 0.08f, 0.10f, 0.95f);
    ImVec4 bg1 = ImVec4(0.12f, 0.12f, 0.14f, 1.00f);
    ImVec4 bg2 = ImVec4(0.16f, 0.16f, 0.18f, 1.00f);
    ImVec4 fg0 = ImVec4(0.95f, 0.95f, 0.98f, 1.00f);
    ImVec4 fg1 = ImVec4(0.65f, 0.65f, 0.70f, 1.00f);
    ImVec4 accent = ImVec4(0.26f, 0.59f, 0.98f, 1.00f);      // Bright blue
    ImVec4 accentDim = ImVec4(0.26f, 0.59f, 0.98f, 0.40f);
    ImVec4 accentGlow = ImVec4(0.30f, 0.65f, 1.00f, 0.6f);  // Lighter blue for hover

    style.Colors[ImGuiCol_Text]                   = fg0;
    style.Colors[ImGuiCol_TextDisabled]           = fg1;
    style.Colors[ImGuiCol_WindowBg]               = bg0;
    style.Colors[ImGuiCol_ChildBg]                = ImVec4(0,0,0,0);
    style.Colors[ImGuiCol_PopupBg]                = bg1;
    style.Colors[ImGuiCol_Border]                 = ImVec4(0.26f, 0.59f, 0.98f, 0.25f);
    style.Colors[ImGuiCol_BorderShadow]           = ImVec4(0,0,0,0);
    style.Colors[ImGuiCol_FrameBg]                = bg1;
    style.Colors[ImGuiCol_FrameBgHovered]         = ImVec4(0.18f, 0.18f, 0.21f, 1.00f);
    ...
    style.Colors[ImGuiCol_ButtonActive]           = ImVec4(0.10f, 0.53f, 0.98f, 1.00f);
    style.Colors[ImGuiCol_Header]                 = accentDim;
    style.Colors[ImGuiCol_HeaderHovered]          = accent;
    style.Colors[ImGuiCol_HeaderActive]           = accent;
    style.Colors[ImGuiCol_Separator]              = ImVec4(0.26f, 0.59f, 0.98f, 0.35f);
    style.Colors[ImGuiCol_SeparatorHovered]       = ImVec4(0.26f, 0.59f, 0.98f, 0.6f);
    style.Colors[ImGuiCol_SeparatorActive]        = accent;
    style.Colors[ImGuiCol_ResizeGrip]             = accentDim;
    style.Colors[ImGuiCol_ResizeGripHovered]      = accent;
    style.Colors[ImGuiCol_ResizeGripActive]       = accent;
    style.Colors[ImGuiCol_Tab]                    = ImVec4(0.16f, 0.25f, 0.39f, 0.86f);
    ...
    style.Colors[ImGuiCol_TabUnfocusedActive]     = ImVec4(0.16f, 0.25f, 0.39f, 1.00f);
    ...
    style.Colors[ImGuiCol_TableBorderStrong]      = ImVec4(0.25f, 0.25f, 0.28f, 1.00f);
    ...
    style.Colors[ImGuiCol_TextSelectedBg]         = accentDim;
